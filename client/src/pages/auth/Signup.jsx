...
export default function Signup() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#020617] px-4 py-10">
      <motion.div
      ...
      >
        ...
        {/* Card */}
        <Card className="rounded-3xl border border-slate-800 bg-slate-950/90 p-8 shadow-2xl">
