export default {
  ...
  plugins: [
    function ({ addUtilities }) {
      addUtilities({
        '.glass': {
          '@apply bg-white/30 dark:bg-slate-900/30 backdrop-blur-md border border-white/20 dark:border-slate-700/30': {},
        },
        '.glass-sm': {
          '@apply bg-white/20 dark:bg-slate-900/20 backdrop-blur-sm border border-white/10 dark:border-slate-700/20': {},
        },
        '.text-gradient': {
